...
//
// class KhatmaOptionsPage extends StatefulWidget {
//   KhatmaOptionsPage({super.key});
//
//   @override
//   State<KhatmaOptionsPage> createState() => _HomePageState();
// }
//
// class _HomePageState extends State<KhatmaOptionsPage> {
...
//                         Navigator.of(context).push(MaterialPageRoute(
//                             builder: (context) =>
//                                 GradientBackground(child: AlKhatmatPage(initialPersons: ,))));
//                       }),
//                     ],
//                   ),
//                 ),
